...
predicted_probability <- bind_cols(
  read_csv(paste0(path_pasc_cmr_folder,"/working/models pcrab/pcrab105_predicted probability for exposed_min10_ntree2000.csv")),
  read_csv(paste0(path_pasc_cmr_folder,"/working/models pcrab/pcrab105_predicted probability for unexposed_min10_ntree2000.csv")),
  read_csv(paste0(path_pasc_cmr_folder,"/working/models pcrab/pcrab105_predicted probability for historical_min10_ntree2000.csv"))) %>% 
...
demographic %>% 
  ...
  saveRDS(.,paste0(path_pasc_cmr_folder,"/working/models pcrab/pcrab201_ip weights for cohort membership.RDS"))
