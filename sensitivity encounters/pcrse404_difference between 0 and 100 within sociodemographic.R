...
bmi_fit_overall <- readRDS(paste0(path_pasc_cmr_folder,"/working/sensitivity encounters/pcrse401 bmi_fit.RDS"))

bmi_fit_sex <- readRDS(paste0(path_pasc_cmr_folder,"/working/sensitivity encounters/pcrse402 bmi_fit_sex.RDS"))
bmi_fit_age <- readRDS(paste0(path_pasc_cmr_folder,"/working/sensitivity encounters/pcrse402 bmi_fit_age.RDS"))
bmi_fit_raceeth <- readRDS(paste0(path_pasc_cmr_folder,"/working/sensitivity encounters/pcrse402 bmi_fit_raceeth.RDS"))
bmi_fit_hospitalization <- readRDS(paste0(path_pasc_cmr_folder,"/working/sensitivity encounters/pcrse402 bmi_fit_hospitalization.RDS"))
...
bind_rows(contrast_overall,
  ...
  write_csv(.,"sensitivity encounters/pcrse404_difference between 0 and 100 within sociodemographic.csv")
