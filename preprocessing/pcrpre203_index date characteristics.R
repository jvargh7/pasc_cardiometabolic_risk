...
(index_date_characteristics <- readRDS(paste0(path_pasc_cmr_folder,"/working/cleaned/pcrpre101_demographic.RDS")) %>% 
  ...
  left_join(glucose %>% 
            ...
            by = "ID")) %>% 
  saveRDS(.,paste0(path_pasc_cmr_folder,"/working/cleaned/pcrpre203_index date characteristics.RDS"))
