...
cdc_testing_rates <- read_csv(paste0(path_pasc_cmr_folder,"/working/raw/United_States_COVID-19_County_Level_of_Community_Transmission_Historical_Changes_-_ARCHIVED.csv")) %>% 
