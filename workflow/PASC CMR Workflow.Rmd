...
This sub-step in the **PREPROCESSING** workflow consists of analytic files starting with **pcrpre3**.

- repo/preprocessing/pcrpre301_high dimensional comorbidities
...
- repo/preprocessing/pcrpre302_high dimensional procedures
    + Extract LOINC codes
    + Group them using [HCUP Clinical Classification Codes](https://hcup-us.ahrq.gov/toolssoftware/ccsr/dxccsr.jsp)
    + Merge into main dataset and summarize

- repo/preprocessing/pcrpre303_high dimensional medication
    + Extract RxCUI codes
    + Group them into ATC classes using [getClassByRxNormDrugId](https://lhncbc.nlm.nih.gov/RxNav/APIs/api-RxClass.getClassByRxNormDrugId.html)
    + Merge into main dataset and summarize
